...
namespace ServerMonitor.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260908174142_AddLastResponseTime")]
    partial class AddLastResponseTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServerMonitor.Domain.Entities.Alert", b =>
                {
                    ...
                    b.HasIndex("TargetId", "ResolvedAt");

                    b.ToTable("Alerts");
                });

            modelBuilder.Entity("ServerMonitor.Domain.Entities.CheckResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ServerMonitor.Domain.Entities.MonitoredTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServerMonitor.Infrastructure.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ServerMonitor.Infrastructure.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ServerMonitor.Domain.Entities.Alert", b =>
                {
                    b.HasOne("ServerMonitor.Domain.Entities.MonitoredTarget", "Target")
                        .WithMany("Alerts")
